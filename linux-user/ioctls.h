...
#ifdef __ANDROID__
  IOCTL(BINDER_WRITE_READ, IOC_RW, MK_PTR(MK_ARRAY(TYPE_ULONGLONG, 6)))
  IOCTL(BINDER_SET_MAX_THREADS, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(BINDER_VERSION, IOC_RW, MK_PTR(TYPE_INT))
#endif
