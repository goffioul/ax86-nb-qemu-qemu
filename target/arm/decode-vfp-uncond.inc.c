...
static bool disas_vfp_uncond(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0xfe000a00:
        ...
        case 0x0:
            /* 11111110 0....... ....1010 .0.0.... */
            /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:44 */
    ...
    case 0xfe000b00:
        ...
        case 0x0:
            /* 11111110 0....... ....1011 .0.0.... */
            /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:46 */
            if (trans_VSEL(ctx, &u.f_disas_vfp_uncond0)) return true;
            return false;
        }
        return false;
    case 0xfe800a00:
        ...
        case 0x0:
            ...
            /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:49 */
        ...
        case 0x3:
            ...
            case 0x00080040:
                ...
                case 0x0:
                    ...
                    /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:54 */
            ...
            case 0x000c0040:
                ...
                /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:60 */
    ...
    case 0xfe800b00:
        ...
        case 0x0:
            ...
            /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:51 */
        ...
        case 0x3:
            ...
            case 0x00080040:
                ...
                case 0x0:
                    ...
                    /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:56 */
                    if (trans_VRINT(ctx, &u.f_disas_vfp_uncond2)) return true;
                    return false;
                }
                return false;
            case 0x000c0040:
                ...
                /* /home/goffioul/Sources/Lincor/local/android/android-x86-10/vendor/lincor/ls1853/libunb/qemu/target/arm/vfp-uncond.decode:62 */
